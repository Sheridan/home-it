...
--run_once("virtualbox")
-- run_once("wmcube -Gb")
-- run_once("wmload -led green")
-- run_once("wmcalc")
-- -- run_once("wmforkplop")
-- -- run_once("wmcpuwatch")
-- -- run_once("wmifs")
-- run_once("wmnet -W enp3s0 --rxcolor=green --txcolor=red")
-- -- run_once("wmfire -m -f 1 -l -y")
-- run_once("wmping")
-- -- run_once("wmSMPmon")
-- run_once("wmbinclock -i green -o gray -d gold")
-- run_once("wmmemload --broken-wm --ignore-buffers --ignore-cached")
-- run_once("wmmemload --broken-wm")
-- run_once("wmcpuload --broken-wm --cpu 0")
-- run_once("wmcpuload --broken-wm --cpu 1")
-- run_once("wmcpuload --broken-wm --cpu 2")
-- run_once("wmcpuload --broken-wm --cpu 3")
-- run_once("wmcpuload --broken-wm --cpu 4")
-- run_once("wmcpuload --broken-wm --cpu 5")
-- run_once("wmcpuload --broken-wm --cpu 6")
-- run_once("wmcpuload --broken-wm --cpu 7")
init_wallpapers()
